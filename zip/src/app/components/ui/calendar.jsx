  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell(
          "relative p-0 text-center text-sm focus-within focus-within:z-20 [&([aria-selected])]-accent [&([aria-selected].day-range-end)]-r-md",
          props.mode === "range"
      ...
      components={{
        IconLeft: ({ className, ...props }) {cn("size-4", className)} {...props }) { className, ...props }) {cn("size-4", className)} {...props} />
        ),
      }}
      {...props}
    />

...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      {...props }) {children }) {viewport && <NavigationMenuViewport />}
    </NavigationMenuPrimitive.Root>
  );
}
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion^=from-]-in data-[motion^=to-]-out data-[motion^=from-]-in data-[motion^=to-]-out data-[motion=from-end]-in-from-right-52 data-[motion=from-start]-in-from-left-52 data-[motion=to-end]-out-to-right-52 data-[motion=to-start]-out-to-left-52 top-0 left-0 w-full p-2 pr-2.5 md md:w-auto",
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:animate-out-95 data-[state=open]:animate-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border shadow md:w-[var(--radix-navigation-menu-viewport-width)]",
          className,
        )}
        {...props}
      />
